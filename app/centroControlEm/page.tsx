...
const CentroControlEmpleado = () => {
    return ( 
        <div>            
            ...
            <div className="w-full h-20 flex items-center justify-between shadow-md ">
               ...
               <div className="flex items-center gap-4 ml-4">
                <div className="bg-blue-600 w-13 h-13 rounded-2xl flex items-center justify-center">
        ...
        <section className=" bg-gradient-to-br from-blue-50 via-sky-50 to-blue-100 w-full h-screen ">
            ...
            <div>
                ...
                <TarjetaLinkeadas titulo="Ingrese Vehiculo" descripcion="Registrar entrada" color="bg-green-500"/>
